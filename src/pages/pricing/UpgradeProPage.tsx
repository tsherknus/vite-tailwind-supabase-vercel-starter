function UpgradeProPage() {
    return (
        <div className="flex flex-col w-full">
            <p className="mt-2 font-bold text-lg">You'll need to subscribe to unlock those pro level features.</p>
            <p className="my-2 font-bold text-lg">Go pro today upgrade your account.</p>
